...
var jze = window.jQuery || window.Zepto || window.ender;

// Backbone.Marionette AMD wrapper with namespace fallback
if (typeof define === 'function' && define.amd) {
    ...
    define([
      ...
      'underscore'  // use jrburke's https://github.com/amdjs/underscore.git
        ...
        return marionette(Backbone, _, jze);
      });
} else {
    // No AMD, use Backbone namespace
    root.Backbone = Backbone || {};
    root.Backbone.Marionette = marionette(Backbone, _, jze);
}
